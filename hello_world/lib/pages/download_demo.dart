...
class DownloadDemo extends StatefulWidget {
  ...
  DownloadDemo({Key key, this.platform}) : super(key: key);

  @override
  _DownloadDemoState createState() => new _DownloadDemoState();
}

class _DownloadDemoState extends State<DownloadDemo> with WidgetsBindingObserver {
  final _documents = [
    {
