...
class _MyAppState extends State<MyApp> {
  ...
  // String broker = 'ws://broker.mqttdashboard.com/mqtt';
  // String broker = 'ws://120.79.12.24/mqtt';
  // String broker = '120.79.12.24';
  ...
  void _connect() async {
    ...
    client = mqtt.MqttClient.withPort(broker, 'fftqaq123456', 1883);
    // client = mqtt.MqttClient.withPort(broker, 'fftqaq123456', 8083);
    // client = mqtt.MqttClient.withPort(broker, 'fftqaq123456', 8000);
    /// use mqtt v3.1.1
    ...
    try {
      ...
      await client.connect('codefray', 'code0mqttf');
    } catch (e) {
      print(e);
      _disconnect();
    }
